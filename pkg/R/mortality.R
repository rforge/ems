...
#'
#' @param period a numerical vector that contains the months when the patients were adimitted to the hospital unit. If period variable is NULL (the default), the function will return a single mortality rate.
#'
